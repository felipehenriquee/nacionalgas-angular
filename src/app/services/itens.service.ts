...
export class ItensService {
  ...
  criaObjetos(){
    this.objetos = [new Itens(
      ...
      "./assets/qrcode/SKIDDEP-2000COMPITSTOP.jpg", 
      ...
      new Itens(
        ...
        "./assets/qrcode/SKIDDEP-2000COMVAPORIZADORELÉTRICO.jpg", 
      ...
      "./assets/qrcode/SKIDDEP-4000COMVAPORIZADORELÉTRICO.jpg",
